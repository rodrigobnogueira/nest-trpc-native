...
| Package source functions stay within the cognitive-complexity threshold. | `eslint.complexity-check.config.mjs`, `npm run complexity:check`, `.github/workflows/ci.yml` | Covered by CI threshold check. |
